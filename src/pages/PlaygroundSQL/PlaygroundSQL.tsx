        ...
        >
          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              SQL Injection <span className="text-blue-500">Playground</span>
            </h1>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start mb-3">
                  <Database className="w-8 h-8 text-blue-400 mr-3 flex-shrink-0" />
          ...
          {selectedChallenge && (
            ...
            >
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-900 to-black border border-blue-500/30 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
              >
                <div className="flex items-start mb-6">
                  <Database className="w-10 h-10 text-blue-400 mr-4 flex-shrink-0" />
                  <div className="flex-1">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full bg-black/50 border border-blue-500/30 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 font-mono text-sm"
                    rows={4}
                  />
                </div>
