...
export default function Settings() {
  ...
  const ToggleSwitch = ({ enabled, onToggle, color = 'bg-primary' }: { enabled: boolean; onToggle: () => void; color?: string }) => (
    <button
      onClick={onToggle}
      className={`relative w-11 h-6 rounded-full transition-all duration-200 ${enabled ? color : 'bg-white/10'
        }`}
    >
      <div
        className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-all duration-200 ${enabled ? 'left-6' : 'left-1'
          }`}
      />
    </button>
  );
      ...
      <div className="container-custom">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 mb-6">
            ...
            <span className="text-xs font-medium text-gray-300 uppercase tracking-wide">Settings</span>
          </div>
                    ...
                    <div className="rounded-xl p-6 bg-white/5 border border-white/10">
                      <div className="flex items-start justify-between mb-8">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">Update your personal details and contact information</p>
                        </div>
                      ...
                      <div className="mb-6 pb-6 border-b border-white/10">
                        ...
                        <div className="flex items-center gap-6">
                          <div className="relative">
                            <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20 overflow-hidden">
                              {profilePhoto ? (
                            ...
                            <button
                              ...
                              className="absolute bottom-0 right-0 p-2 rounded-full bg-primary hover:bg-primary/90 transition-colors border border-primary/50"
                            >
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-400">{getTimeSincePasswordChange()}</p>
                              </div>
                            </div>
                            <Button
                              variant="outline"
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-400">{sessions.length} device{sessions.length !== 1 ? 's' : ''} logged in</p>
                              </div>
                            </div>
                            <Button
                              variant="outline"
